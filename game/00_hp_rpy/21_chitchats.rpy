...
#########   JJ Edits   12/29/2014  ###########################################
#    sna[1] "So..."
#    sna[1] "I hear miss Granger is taking private lessons from you now?"
#    m "Yeah, I suppose she does..."
#    m "Not sure where this fits into our plan though."
#    sna[9] "What do you mean? It fits perfectly."
#    sna[9] "I myself and a couple of other teacher are failing the crap out of that girl!"
#    sna[9] "As a result she spends more time with studying..."
#    sna[9] "Even taking private lessons now..."
#    sna[18] "This way she has very little time left to be noisy and cause me headaches."
#    m "I see..."
#    sna[10] "Yes, yes... just, you so know..."
#    sna[10] "Don't actually teach her anything useful, alright?"
#    m "I'll do my best."
#    sna[1] "Well, if there is that's all..."
###  Altered this chit chat to reflect JJ's tutoring results  
    sna[1]  "The Granger girl is driving me mad with her accusations.  They must stop!  I think she was even coming on to me!"  
    sna[7] "As though I would fall for such a transparent ploy! Though she does look to have a luscious body under that frumpy sweater..."
    sna[4] "Have you done anything to deal with her?  If you have not..."
    sna[9] "I found a lovely potion in my cupboard that will put her into a long, wasting slumber for which there is no antidote."
    m  "Don’t worry, Severus.  I have her well in hand."  
    sna[10]  "Oh, really?  How?"  
    m "Well, for starters she is seeing me for magic lessons.  I am teaching her how to do magic without wands or incantations."
    sna[17] "But that’s nearly impossible for someone of her age!  All but the most powerful wizards and witches must use wands."  
    sna[2] "And at her ability level she will need to verbalize all but the simplest spells."
    m  "Not to worry.  I plan to teach her how I do magic and I don’t need to do any of that."
    sna[6] "That's ridiculous!  Your magic only works for you!"
    m "Exactly!"
    sna[18] "Oh, you are devious!  But you said for starters..."
    m "Are you familiar with a Professor Trelawney?"
    sna[15] "Sybil Trelawney?  That idiot?!?  Her so-called classes are a blot upon the school’s reputation!"
    sna[7] "She’s a laughing-stock among all of the other schools in Europe!"
    ...
    sna[7] "What rubbish is this?  Magical auras?  Transferring to a wand?  There's no such thing!"
    ...
    sna[8] "That's...despicable.  I wish I had thought of that."
    ...
    sna[8] "......................"
    sna[18] "That’s...that’s more brutal than I think I would have been.  And I hate the Granger bitch!"
    ...
    sna[18]  "..........................."
    sna[15]  "Ah ha ha ha!  I am so very, very glad you are my ally and not my enemy."
    m "That’s kind of you to say Severus."  
    sna[18]  "I think I'll return to my office and think about how best to leverage this new information before my next class begins."
    m "Good day, Severus."
# End alteration  JJ
