...
label new_request_01: #LV.1 (Whoring = 0 - 2)
    ...
    if ("maid" in outfit_invintory or "gryffindor_cheerleader" in outfit_invintory or in outfit_invintory "slytherin_cheerleader" in outfit_invintory or "ms_marvel" in outfit_invintory or "heart_dancer" in outfit_invintory or "power_girl" in outfit_invintory or "harley_quinn" in outfit_invintory):
        ...
        if snape_invated_to_watch: #Turns TRUE when Hermione is stripping and Snape walks in on you. Allows to invite him to watch her strip next time.
            ...
            menu:
                "\"Yes! Hermione needs an audience!\"":
                    ...
                    call sna_head("Oh! It's \"[genie_name]\" now, isn't I?","snape_03")
