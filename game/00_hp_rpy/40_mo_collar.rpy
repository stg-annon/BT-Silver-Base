...
label collar_scene:
    ...
    $ her_main("[genie_name], am I a slut?","body_21")
    m "What are you talking about?"
    $ her_main("Susan Bones is telling everyone in the school that I'm a slut!","body_04")
    m "Why is this Miss Bones calling you a slut?"
    $ her_main("Because she found out what we are doing! She's telling everyone that I'm your slut!","body_19")
    $ her_main("My reputation is ruined! What will people think when they find out what I've been doing with my ninety year old Professor?","body_20")
    $ her_main("I'll be known as a slut for the the rest of my life!","body_32")
    her "I'll never be able to get a good job..."
    her "My friends will hate me..."
    $ her_main("Please, You don't think I'm a slut do you [genie_name]?","body_31")
    menu:
...
label slut_scene: #Locked to her being your slut
    ...
    menu:
        "-Throat fuck-":
            ...
            $ her_main("eeettsss hhooooo hhhhggggg!","body_39")
            hide screen hermione_main
            ...
            $ her_main("*Slurp!* *Gltch!* *Gulp!*","body_115")
            hide screen hermione_main
            m "I asked you a question slut."
            $ her_main("hhyyym aaaa hhhhtttt","body_116")
            hide screen hermione_main
            ...
            $ her_main("hhhhyyyyyym aaaaaaa hhhhhhhhttttttt!","body_48")
            hide screen hermione_main
            ...
            hide screen g_c_u
            with d3
            $ her_main("{size=+10}I'm a slut!{/size}","body_32")
            hide screen hermione_main
            m "Yes you are."
        ...
        "-Let her suck you-":
            ...
            $ her_main("...yes. I am a massive slut.","body_33")
            hide screen hermione_main
            m "Good to hear you finally admit it. Now, back in the mouth."
            $ her_main("Yes [genie_name]","body_64")
            hide screen hermione_main
    ...
    $ her_main("You can't be serious?!","body_120")
    hide screen hermione_main
    m "I am, and if you ever want to suck my cock again you will do as I say."
    $ her_main("...yes [genie_name].","body_127")
    hide screen hermione_main
    m "Well get going."
    $ her_main("Good night [genie_name].","body_128")
    hide screen hermione_main
    m "Good night. {w}Slut."
    $ her_main("...","body_124")
    show screen genie
...
label whore_scene: #(locked behind the public whoring flag)
    ...
    $ her_main("Thank you si-","body_67")
    m "You're worse than a slut, you're a whore."
    $ her_main("What? What's the difference?","body_117")
    ...
    $ her_main("Sir please, you're being too mean...","body_132")
    m "Oh is the little whore getting upset? Don't worry, I'll make you feel all better."
    her "How?"
    m "Come over here and bend over."
    $ her_main("You can't be serious? After what you just said?","body_117")
    ...
    $ her_main("...","body_118")
    hide screen hermione_main
    $ her_main("Please [genie_name].","body_87")
    hide screen hermione_main
    m "Please what?"
    $ her_main("Please fuck me...","body_67")
    hide screen hermione_main
    m "I'm not sure I quite heard that. You'll have to speak up."
    $ her_main("{size=+5}Please fuck my cunt{/size}","body_130")
    hide screen hermione_main
    ...
    $ her_main("{size=-5}I'm a whore.{/size}","body_136")
    hide screen hermione_main
    m "What was that, I couldn't hear you ever the sound of me fucking you."
    $ her_main("I'm a whore.","body_134")
    hide screen hermione_main
    m "Very good, now beg me."
    $ her_main("Beg you to what?","body_133")
    hide screen hermione_main
    m "Beg me to cum inside your pussy, whore."
    $ her_main("Please fill my little pussy with your thick cum.","body_123")
    hide screen hermione_main
    ...
    hide screen hermione_main
    m "Tell me girl."
    $ her_main("I beg every boy that fucks me to cum inside!","body_132")
    hide screen hermione_main
    m "What a fucking whore."
    $ her_main("I-I'm cumming.","body_144")
    hide screen hermione_main
    ...
    $ her_main("...Thank you [genie_name].","body_157")
    hide screen hermione_main
    m "Thank you for what?"
    $ her_main("Thank you for ... cumming in my pussy.","body_158")
    hide screen hermione_main
    m "You're welcome girl. A good whore should always be grateful."
    $ her_main("Yes [genie_name].","body_155")
    hide screen hermione_main
    show screen blkfade
    with d3                                                                                                                                                                                 #HERMIONE
    show screen genie
    ...
    #$ her_main("...yes [genie_name].","body_145")
...
label slave_scene: 
    ...
    $ her_main("Thank yo-","body_45")
    m "You're a slave."
    $ her_main("I'm a what?","body_44")
    m "You're a slave Miss Granger. Specifically, my slave."
    $ her_main("What are you talking about? I'm not your slave.","body_47")
    ...
    $ her_main("Well, I...","body_29")
    m "Exactly, you've become my slave and you didn't even realise it."
    $ her_main("Just because I care about my house doesn't mean that-","body_34")
    ...
    $ her_main("You.","body_87")
    hide screen hermione_main
    m "Good, and who am I?"
    $ her_main("Professor Dumbledore.","body_68")
    hide screen hermione_main
    ...
    $ her_main("I'm not?","body_79")
    hide screen hermione_main
    m "No, of course not."
    m "You're my personal slave."
    $ her_main("I think I'm about to cum master.","body_118")
    hide screen hermione_main
    $ renpy.play('sounds/slap.mp3')
    show screen white 
    pause.1
    ...
    $ her_main("Please master, may I cum?","body_119")
    hide screen hermione_main
    m "Not until I do."
    $ her_main("Please hurry.","body_131")
    hide screen hermione_main
    ...
    $ her_main("I'm cumming!","body_130")
    hide screen hermione_main
    ">You continue to shoot ropes of cum into her asshole."
    $ her_main("Thank you sir.","body_121")
    hide screen hermione_main
    $ renpy.play('sounds/slap.mp3')
    show screen white 
    pause.1
    ...
    $ her_main("Master's slave.","body_124")
    hide screen hermione_main
...
label good_girl_scene:
    ...
    $ her_main("*sob* Really [genie_name]?","body_131")
    m "Really. You wouldn't have done any of this if the point system was fair would you?"
    $ her_main("*sob* I guess not...","body_117")
    m "I'm sure once Miss Bones realises what you are doing this for she will understand."
    $ her_main("Do you really think so [genie_name]?","body_118")
    m "I do, you're a good girl Miss Granger."
    $ her_main("Thank you [genie_name].","body_45")
    m "Once Gryffindor wins the house cup no one will even remember what they said about you they'll be so grateful."
    $ her_main("Yes, you're right [genie_name]. I suppose that I was just overreacting.","body_74")
    m "Don't worry about it."
    $ her_main("Before I go...","body_68")
    $ her_main("Do you think that you could buy a favor off of me?","body_64")
    m "Sure, what would you like to do?"
    $ her_main("Well I suppose that I could show you my breasts.","body_124")
    $ her_main("For 50 points of course...","body_122")
    m "That seems fair."
    $ her_main("Thank you [genie_name].","body_128")
    ">Hermione slowly lifts her top."
    $ lift_shirt = True
    $ badges = False
    $ her_main("Do you like them [genie_name]","body_82")
    m "Of course I do, they're lovely."
    $ her_main("Thank you [genie_name], you're always so kind.","body_84")
    ">She lowers her top."
    $ lift_shirt = False
    $ badges = True
    m "50 points to Gryffindor."
    $ gryffindor += 50
    $ her_main("Thank you [genie_name]. Have a nice night.","body_111")
