init python:
    ...
    if not hasattr(renpy.store,'hg_pf_NicePanties_OBJ.menu_text'): #important!
    ...
    if not hasattr(renpy.store,'hg_pf_BreastMolester_OBJ.menu_text'): #important!
    ...
    if not hasattr(renpy.store,'hg_pf_ButtMolester_OBJ.menu_text'): #important!
    ...
    if not hasattr(renpy.store,'hg_pf_ShowThemToMe_OBJ.menu_text'): #important!
    ...
    if not hasattr(renpy.store,'hg_pf_LetMeTouchThem_OBJ.menu_text'): #important!
    ...
    if not hasattr(renpy.store,'hg_pf_TouchMe_OBJ.menu_text'): #important!
    ...
    if not hasattr(renpy.store,'hg_pf_SuckIt_OBJ.menu_text'): #important!
    ...
    if not hasattr(renpy.store,'hg_pf_LetsHaveSex_OBJ.menu_text'): #important!
    ...
    if not hasattr(renpy.store,'hg_pf_TimeForAnal_OBJ.menu_text'): #important!
    ...
    if not hasattr(renpy.store,'hg_pr_FlirtClassmate_OBJ.menu_text'): #important!
    ...
    if not hasattr(renpy.store,'hg_pr_FlirtTeacher_OBJ.menu_text'): #important!
    ...
    if not hasattr(renpy.store,'hg_pr_ClassmateTouchYou_OBJ.menu_text'): #important!
    ...
    if not hasattr(renpy.store,'hg_pr_FlashClassmate_OBJ.menu_text'): #important!
    ...
    if not hasattr(renpy.store,'hg_pr_KissAGirl_OBJ.menu_text'): #important!
    ...
    if not hasattr(renpy.store,'hg_pr_HandjobClassmate_OBJ.menu_text'): #important!
    ...
    if not hasattr(renpy.store,'hg_pr_BlowjobClassmate_OBJ.menu_text'): #important!
    ...
    if not hasattr(renpy.store,'hg_pr_SexWithClassmate_OBJ.menu_text'): #important!
    ...
    if not hasattr(renpy.store,'hg_ps_PantyThief_OBJ.menu_text'): #important!
    ...
    if not hasattr(renpy.store,'hg_ps_WalkOfShame_OBJ.menu_text'): #important!
    ...
    if not hasattr(renpy.store,'hg_ps_WearMyCum_OBJ.menu_text'): #important!
    ...
    if not hasattr(renpy.store,'hg_ps_LeashWalk_OBJ.menu_text'): #important!
