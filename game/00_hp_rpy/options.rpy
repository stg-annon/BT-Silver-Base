...
init -1 python hide:
    ...
    config.autoreload = True # If false, Ren'Py will reload the game once per press of shift+R.
    ...
    config.window_title = u"Bitch Trainer Silver"
    ...
    config.main_menu_music = "cliffcore.mp3"
...
python early:
    config.save_directory = "Bitch Trainer"
...
init -1 python hide:
 ...
 ########################################################################################
    style.say_who_window.background = Frame("PinkBox.png", 15, 15) #Background skin
