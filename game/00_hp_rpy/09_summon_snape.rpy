...
label special_date_with_snape: #TAKES PLACE AFTER FIRST VISIT FROM HERMIONE.
    ...
    sna[2] "..........................."
    m "...............................?"
    sna[3] "I hate her so much..."
    menu:
        "\"Yeah! That bitch!\"":
            sna[1] "Good to know that we are on the same page..."
            sna[2] "That girl..."
        "\"You hate who?\"":
            sna[1] "Why would you ask that?"
            sna[1] "That Hermione girl of course!"
        "\"Is she that bad?\"":
            sna[1] "She is the worst!"

    sna[2] "A top student..."
    sna[3] "Leads all sorts of extracurricular activities and clubs..."
    sna[3] "the president of the school's Student Representative Body..."
    sna[3] "Likely to become the head girl soon..."
    sna[2] "................"
    sna[3] "............"
    with hpunch
    sna[5] "{size=+7}I hate that fucking witch!!!{/size}"
    g4 "{size=-4}(What the...?){/size}"
    sna[2] ".............."
    sna[2] "She used to be just an annoyance, but these days..."
    sna[1] "She became a fully fledged menace..."
    sna[1] "That witch is officially my least favorite student in the entire school now..."
    m "What about that Potter boy?"
    sna[6] "The Potter boy? Ha! Who's that!?"
    sna[1] "No I'm serious..."
    sna[1] "I will go as far as to say that Potter jr. and his wretched father combined..."
    sna[1] "Didn't cause me nearly as much grief as this little witch does lately..."
    m "Now, now, we both know that's not true..."
    sna[2] "Yeah... You're probably right..."
    sna[7] "That bastard James Potter really did a number on me--"
    sna[6] "Wait, how do you know this?"
    m "Well... I've read the books..."
    sna[6] "What? What books?"
    m "Nah, never-mind. I'm a genie, remember? I know things..."
    sna[9] "Hm... And yet you need me to teach you stuff..."
    ...
    m "The Hermione girl..."
    sna[1] "What?!"
    sna[2] "I thought we agreed on the \"no human contact\" rule."
    sna[7] "(Even though lately I've been wondering whether or not she is human at all...)"
    m "I know... She kinda forced her way in..."
    sna[1] "I imagine she did..."
    sna[1] "What did she want?"
    ...
    if jerk_off_session:
        ...
        sna[2] "You... y-you...."
        sna[12] "......"
        sna[15] "Ha.... ha-ha... HA-HA-HA!!!"
        m "Wha..? What did I say?"
        sna[14] "Ha-ha-ha! You are amazing!"
        sna[9] "Are all genies so... wonderfully nihilistic?"
        m "Yeah... We immortals tend to not give a fuck."
        sna[9] "Understandable..."
        sna[10] "Unfortunately, us mere mortal cannot afford such luxury..."
        ...
        sna[1] "Nah... Probably another load of self righteous crap..."
        sna[7] "She is famous for that..."
    

    sna[7] "I have a class early tomorrow, so let us call it a night."
    m "What about you teaching me magic and stuff?"
    sna[10] "Yeah, absolutely..."
    sna[10] "Next time..."
    m "Alright..."
...
label special_date_with_snape_02: #TAKES PLACE AFTER SECOND VISIT FROM HERMIONE. (Where she says that she sent letter to the ministry.)
    ...
    sna[1] "Don't mention the witch's name when I'm off duty..."
    sna[2] "..............."
    sna[3] "Dammit! I am a grown man, Albus!"
    m "My name is not--"
    sna[3] "An esteemed wizard..."
    m "Well, alright, let it out..."
    sna[2] "How come one tiny....cunt, is able to cause me so much grief?!"
    sna[4] "I thought with you as my ally I will have a chance to--"
    m "To unclench?" 
    sna[2] "Yeah, that could be the word..."
    sna[16] "But all I did was give her more leverage to harass me with..."
    sna[16] "She's even turning the teachers against me now..."
    sna[3] "................."
    sna[7] "She must go..."
    m "What do you mean?"
    with hpunch
    sna[5] "{size=+6}I will have to kill her!{/size}"
    g4 "Like literally kill her?"
    sna[6] "Do I have any other choice?"
    m "You're joking, right?"
    sna[6] "Am i?!"
    sna[11] "Can you do this for me?"
    m "Em..."
    ...
    if jerk_off_session:
        sna[17] "Really? I thought you didn't give a fuck..."
        m "to a certain degree..."
        sna[7] "............."
    sna[2] "Well... don't mind me then..."
    sna[2] "I'm all talk..."
    sna[2] "I would never actually harm a student..."
    sna[3] "(...permanently that is.)"
    m "Listen, if she bugs you so much, why not just find a less radical way to deal with her?"
    sna[7] "Nah... Flogging has been outlawed years ago..."
    m "That's not what I mean..."
    sna[1] "Huh?"
    m "She is a top student, right?"
    sna[2] "Yes, damn her. The girl is a hard-worker, I give her that."
    m "She also has a reputation for being self righteous."
    sna[6] "Oh, yes!"
    m "And she thinks that she is better than everyone else..."
    sna[17] "Where are you going with this?"
    m "Well it seems like all of her power comes from her reputation..."
    sna[11] "......................?"
    m "What if we take that away from her?"
    sna[10] "That would shut her up I suppose..."
    sna[2] "But how? She's practically a saint."
    sna[7] "Even students who hate her secretly admire her."
    sna[2] "She didn't fail a single test in her entire time here..."
    sna[2] "She is always ahead of the schedule..."
    sna[3] "Damn, how I hate it when she corrects me during my classes..."
    sna[6] "And thanks to her the \"Gryffindor\" house is way ahead of everybody else now..."
    sna[7] "Even \"Slytherin\" is no match for them this year..."
    sna[16] "........................"
    sna[6] "Dammit... I need more wine..."
    ...
    menu:
        ...
        "{size=-3}\"Make sure she is not a top student any longer!\"{/size}" if not d_flag_01:
            $ d_flag_01 = True
            sna[1] "What? You mean grade her unfairly?"
            sna[2] "Nah... Dumbledore would never allow--"
            sna[9] "Wait a second!"
            m "Exactly!"
            sna[18] "You're right! I grade her tests unfairly! I could even make other teachers do the same!"
            sna[18] "I could say that the order comes from you..."
            sna[19] "And when the real Dumbledore shows up I will pretend that I had no idea that he was away..."
            m "Works for me."
            sna[10] "Er..."
            sna[10] "This is still you, genie, right?"
        ...
        "{size=-3}\"Make sure \"Gryffindor\" loses the cup this year!\"{/size}" if not d_flag_02:
            $ d_flag_02 = True
            sna[1] "You mean to just start subtracting points from them for no good reason?"
            sna[18] "Oh, I like that!"
            sna[20] "There are a couple of \"Slytherin\" girls who are long overdue for receiving some extra house points as well."
            sna[19] "Oh, this will work out magnificently!"
            sna[18] "You are a Genius!"
        ...
        "{size=-3}\"Ruin her reputation!\"{/size}" if not d_flag_03:
            $ d_flag_03 = True
            sna[1] "Tarnish her reputation?"
            sna[1] "But the girl is incorruptible..."
            m "Nonsense!"
            m " All we need to do is convince her that she needs to make some sacrifices \"for the greater good\"."
            sna[9] "Oh, but of course..."
            sna[21] "She would gladly \"Get her hands dirty\" to save the honour of her precious \"Gryffindor\" house!"
            sna[9] "And when she does, we will have the leverage we need..."
            if d_flag_01 and d_flag_02 and d_flag_03:
                pass
            else:
                jump fuck_off

    sna[9] "This could actually work!"
    m "I think so too."
    sna[19] "Oh, I feel so alive tonight!"
    sna[15] "Pour me another goblet!"
    sna[19] "The \"Defence Against the Dark Arts\" class will start late tomorrow!"
    m "....."
    m "Don't you think this is a bit too brutal though?"
    m "I mean, she's just a girl..."
    sna[8] "Just a girl?"
    sna[8] "Oh no, no, no..."
    sna[4] "She is the embodiment of pure evil!"
    sna[2] "If we don't do this now..."
    sna[3] "One of those days I may just snap and \"Avada Kedavra\" her!"
    m "You'll do what?"
    sna[4] "Murder her for real!"
    m "Alright, alright... got it."
    m "Let's choose the lesser of the two evils then."
    sna[7] "Yes..."
    sna[6] "Now, pour me some more wine."
