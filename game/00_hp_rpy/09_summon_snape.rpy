...
label special_date_with_snape_02: #TAKES PLACE AFTER SECOND VISIT FROM HERMIONE. (Where she says that she sent letter to the ministry.)
    ...
    sna_[2] "Yes, damn her. The girl is a hard-worker, I give her that."
    ...
    sna_[2] "She didn't fail a single test in her entire time here..."
    ...
    menu:
        ...
        "{size=-3}\"Make sure she is not a top student any longer!\"{/size}" if not d_flag_01:
            ...
            m "Exactly!"
            sna_[18] "You're right! I grade her tests unfairly! I could even make other teachers do the same!"
